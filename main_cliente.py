...
from licenciamento import verificar_licenca_arquivo

# Versao cliente licenciada.
...
def verificar_licenca_local():
    logging.info("Verificando licenca do cliente...")
    return verificar_licenca_arquivo(BASE_PATH)
...
# ============================================================
# Interface Gráfica (PySide6) - Processo Principal
# ============================================================
